...
def DEVICE_PROJ_NAME ():
    return "novo_reference_nic"

def DEVICE_PROJ_DESC ():
    return "novo reference nic"
...
def SIMULACAO_RD_1_DATA_REG ():         
    return 0x2000000

def SIMULACAO_RD_0_DATA_REG ():         
    return 0x2000004

def SIMULACAO_TUPLE_PSRC_GEN_REG ():    
    return 0x2000008

def SIMULACAO_TUPLE_PDST_GEN_REG ():    
    return 0x200000c

def SIMULACAO_TUPLE_IPSRC_GEN_REG ():   
    return 0x2000010

def SIMULACAO_TUPLE_IPDST_GEN_REG ():   
    return 0x2000014

def SIMULACAO_TUPLE_ACKNUM_GEN_REG ():  
    return 0x2000018

def SIMULACAO_NUM_LEITURA_GEN_REG ():   
    return 0x200001c

def SIMULACAO_NUM_ESCRITA_GEN_REG ():   
    return 0x2000020

def SIMULACAO_NUM_ACK_PKTS_GEN_REG ():  
    return 0x2000024

def SIMULACAO_NUM_ICMP_PKTS_GEN_REG (): 
    return 0x2000028

def SIMULACAO_NUM_UDP_PKTS_GEN_REG ():  
    return 0x200002c

def SIMULACAO_NUM_TCP_PKTS_GEN_REG ():  
    return 0x2000030

def SIMULACAO_NUM_PKTS_GEN_REG ():      
    return 0x2000034
...
__main__.nf_regmap.update({
    ...
    0x2000000 : "SIMULACAO_RD_1_DATA_REG",
    0x2000004 : "SIMULACAO_RD_0_DATA_REG",
    0x2000008 : "SIMULACAO_TUPLE_PSRC_GEN_REG",
    0x200000c : "SIMULACAO_TUPLE_PDST_GEN_REG",
    0x2000010 : "SIMULACAO_TUPLE_IPSRC_GEN_REG",
    0x2000014 : "SIMULACAO_TUPLE_IPDST_GEN_REG",
    0x2000018 : "SIMULACAO_TUPLE_ACKNUM_GEN_REG",
    0x200001c : "SIMULACAO_NUM_LEITURA_GEN_REG",
    0x2000020 : "SIMULACAO_NUM_ESCRITA_GEN_REG",
    0x2000024 : "SIMULACAO_NUM_ACK_PKTS_GEN_REG",
    0x2000028 : "SIMULACAO_NUM_ICMP_PKTS_GEN_REG",
    0x200002c : "SIMULACAO_NUM_UDP_PKTS_GEN_REG",
    0x2000030 : "SIMULACAO_NUM_TCP_PKTS_GEN_REG",
    0x2000034 : "SIMULACAO_NUM_PKTS_GEN_REG",
