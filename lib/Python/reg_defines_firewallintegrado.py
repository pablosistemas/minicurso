...
def MINIFIREWALL_DPORT1_REG (): 
    return 0x2000000

def MINIFIREWALL_DPORT2_REG (): 
    return 0x2000004

def MINIFIREWALL_DPORT3_REG (): 
    return 0x2000008

def MINIFIREWALL_DPORT4_REG (): 
    return 0x200000c
...
__main__.nf_regmap.update({
    ...
    0x2000000 : "MINIFIREWALL_DPORT1_REG",
    0x2000004 : "MINIFIREWALL_DPORT2_REG",
    0x2000008 : "MINIFIREWALL_DPORT3_REG",
    0x200000c : "MINIFIREWALL_DPORT4_REG",
